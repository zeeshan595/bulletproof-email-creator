...
export default class Document extends Template {
  ...
  _rawHTML =
    ...
    '}    </style>  </head>  <body    style="background-color: {BackgroundColor}; line-height: 22px; font-family: Arial, Helvetica, sans-serif; margin: 0;"    bgcolor="{BackgroundColor}"  >    {EmailPreheader} <br />    <br /> {Content} <br />    <br />    {Attachments}{MessageOpen}  </body></html>';
}
